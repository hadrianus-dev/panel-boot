                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-10">
                                            <select wire:model.defer='portfolio.published' class="default-select wide form-control" id="validationCustom05">
                                                <option data-display="{{($portfolio['published'] == true) ? 'Publicado' : 'Rascunho'}} ">Selecionar</option>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="profile-interest">
                                                ...
                                                <div class="row mt-4 sp4" id="lightgallery">
                                                    ...
                                                    @elseif ($oldImage)
                                                    <a href="#" class="mb-1 col-lg-4 col-xl-12 col-sm-4 col-12">
                                                        <img src="{{ asset('storage/'.$oldImage) }}" alt="" class="img-fluid">
                                                    </a>
                                                    @endif
                                                </div>
                                            </div>
