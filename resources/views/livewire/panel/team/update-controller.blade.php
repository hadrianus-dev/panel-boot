            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form wire:submit.prevent='update' class="needs-validation" enctype="multipart/form-data" method="team" novalidate >
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="profile-interest">
                                                <h5 class="text-primary d-inline">Prever Foto</h5>
                                                @if ($cover)
