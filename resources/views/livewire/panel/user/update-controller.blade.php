            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form wire:submit.prevent='update' class="needs-validation" enctype="multipart/form-data" method="user" novalidate >
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="mb-3 row">
                                            ...
                                            <div class="profile-interest">
                                                ...
                                                @if ($cover || $covers)
                                                    <a href="#" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-10">
                                                        <img src="{{ $cover->temporaryUrl() }}" alt="" class="img-fluid mt-4 mb-4 w-50 rounded-circle">
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="profile-interest">
                                                ...
                                                <a href="#" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-10">
                                                    <img src="{{ asset('storage/'. $oldCover) }}" alt="" class="img-fluid mt-4 mb-4 w-50 rounded-circle">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-right">
                                        <button type="update" class="btn btn-primary">Salvar<span
